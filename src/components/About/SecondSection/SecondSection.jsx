  ...
  return (
    <div className={styles.secondSection}>
      <div className={styles.item}>
        ...
        <p className={styles.description}>Также, мы проводим дезинфекцию любых помещений
        вне зависимости от размера как методом холодного тумана, так и обработкой облучателями открытого типа.</p>
      </div>
      <div className={styles.item}>
        <Quality className={styles.icon} />
        <h2 className={styles.title}><span>гарантия</span> качества</h2>
        <p className={styles.description}>Предоставляем весь необходимый для Роспотребнадзора пакет документов. Все применяемые препаратыI  сертифицированы и одобрены к использованию на территории РФ.</p>
      </div>
      <div className={styles.item}>
